...
const Project = ({ type, title, summary, img, link, github }) => {
    return (
        <article className='flex flex-col w-full items-center justify-center rounded-2xl border-2 border-solid border-dark dark:border-light bg-light dark:bg-dark p-6 relative xs:p-4'>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                <span className='text-primary font-light text-base md:text-sm'>{type}</span>
        ...
        <>
            ...
            <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
                <Layout className='pt-16'>
                    <AnimatedText text="Imagination Trumps Knowledge!" className='mb-16 sm:!text-5xl sm:mb-8 xs:!text-4xl' />
                    <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                        ...
                        <div className='col-span-6 sm:col-span-12'>
                           ...
                           local currency."
                                link="/"
                                github="/"
                                type="ReactJS, NodeJS, Tailwind CSS"
                            />
                        </div>
                        <div className='col-span-6 sm:col-span-12'>
                            <Project
