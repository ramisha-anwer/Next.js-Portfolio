...
const Article = ({ img, title, date, link }) => {
    return (
        <li className='relative w-full p-4 my-6 rounded-xl flex items-center justify-between bg-light dark:bg-dark text-dark first:mt-0 border border-dark dark:border-light border-solid border-r-4 border-b-4'>
            <Link href={link}>
                <h2 className='capitalixe text-xl font-semibold hover:underline underline-offset-2 dark:text-light'>
                    {title}</h2>
            </Link>
