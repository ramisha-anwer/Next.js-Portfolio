...
function Skills() {
  return (
      ...
      <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-8 text-center py-8'>
          <div className='flex flex-col items-center justify-center shadow-2xl shadow-gray-200 hover:scale-110 duration-500 py-4 rounded-md border-2 border-solid border-black'>
          ...
          <div className='flex flex-col items-center justify-around shadow-2xl shadow-gray-200 hover:scale-110 duration-500 py-4 rounded-md border-2 border-solid border-black'>
              <Image className='w-[4rem] ' src={AWS}/>
          ...
          <div className='flex flex-col items-center justify-center shadow-2xl shadow-gray-200 hover:scale-110 duration-500 py-4 rounded-md border-2 border-solid border-black'>
              <Image className='w-[4rem] ' src={github}/>
